...
export class Migration1692032654080 implements MigrationInterface {
  name = 'Migration1692032654080';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "favs_tracks_track" ADD CONSTRAINT "FK_de231f68f716751fd438156ba40" FOREIGN KEY ("favsId") REFERENCES "favs"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favs_albums_album" ADD CONSTRAINT "FK_b18e0234b876553233673338c68" FOREIGN KEY ("favsId") REFERENCES "favs"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favs_artists_artist" ADD CONSTRAINT "FK_36bb34af2af752589eec34801b6" FOREIGN KEY ("favsId") REFERENCES "favs"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
